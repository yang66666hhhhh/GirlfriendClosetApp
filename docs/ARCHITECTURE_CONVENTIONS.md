...
- Presentation-only text helpers such as outfit recommendation copy belong in `ClosetApp.UI.Logic/Services`. Use them for pure formatting and copy selection, while keeping loading, commands, and refresh orchestration in the ViewModel.
