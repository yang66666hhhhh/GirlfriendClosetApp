        ...
        Color LavenderText)
    {
        public static ThemePalette Create(AppThemeKind theme)
        {
            return theme switch
            {
                ...
                _ => new ThemePalette(
                    Primary: Color.FromRgb(196, 143, 149),
                    PrimaryDark: Color.FromRgb(164, 113, 121),
                    PrimaryLight: Color.FromRgb(243, 234, 233),
                    PrimaryGlow: Color.FromArgb(60, 196, 143, 149),
                    SurfacePage: Color.FromRgb(246, 242, 239),
                    SurfaceModal: Color.FromRgb(255, 251, 249),
                    SurfaceCard: Color.FromRgb(255, 255, 255),
                    SurfaceHero: Color.FromRgb(244, 237, 234),
                    SurfaceSection: Color.FromRgb(249, 244, 241),
                    SurfaceElevated: Color.FromRgb(255, 255, 255),
                    SurfaceImageArea: Color.FromRgb(244, 238, 234),
                    BorderLight: Color.FromRgb(232, 221, 219),
                    BorderDivider: Color.FromRgb(239, 231, 228),
                    SidebarBackground: Color.FromRgb(251, 247, 244),
                    SidebarBorder: Color.FromRgb(237, 227, 224),
                    ShadowColor: Color.FromArgb(30, 138, 118, 112),
                    SkySurface: Color.FromRgb(246, 240, 239),
                    SkyBorder: Color.FromRgb(231, 219, 217),
                    SkyText: Color.FromRgb(142, 110, 114),
                    MintSurface: Color.FromRgb(247, 240, 236),
                    MintBorder: Color.FromRgb(231, 217, 210),
                    MintText: Color.FromRgb(151, 117, 107),
                    RoseSurface: Color.FromRgb(248, 238, 240),
                    RoseBorder: Color.FromRgb(224, 202, 206),
                    RoseText: Color.FromRgb(158, 108, 116),
                    AmberSurface: Color.FromRgb(248, 241, 232),
                    AmberBorder: Color.FromRgb(230, 215, 196),
                    AmberText: Color.FromRgb(158, 122, 84),
                    LavenderSurface: Color.FromRgb(244, 238, 242),
                    LavenderBorder: Color.FromRgb(220, 208, 216),
                    LavenderText: Color.FromRgb(139, 111, 132))
            };
        }
    }
}
